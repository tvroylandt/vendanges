...
# GIF + export --> à optimiser
pyramide_gif <- animate(pyramide_anim, renderer = gifski_renderer())

gifski::save_gif(pyramide_gif, "outputs/pyramide_anim.gif")
```
